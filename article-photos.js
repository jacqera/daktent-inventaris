...
.article-photos .ap-slides{display:flex;overflow-x:auto;scroll-snap-type:x mandatory;scrollbar-width:none;border-radius:16px;background:#101014;overscroll-behavior-x:contain}.article-photos .ap-slides::-webkit-scrollbar{display:none}
.article-photos .ap-slide{flex:0 0 100%;width:100%;height:clamp(240px,55vh,440px);scroll-snap-align:start;border:0;background:transparent;padding:0;display:block;overflow:hidden;cursor:zoom-in}
.article-photos .ap-slide img{display:block;width:100%;height:100%;object-fit:contain}.article-photos .ap-unavailable{padding:18px;color:var(--muted);text-align:center;font-size:14px}
