const CACHE='daktent-v5';const FILES=['./','index.html','styles.css','login.css','background.css','background.jpg','app.js','api.js','auth.js','storage.js','seed.js','config.js','manifest.webmanifest','assets/icon.svg'];
