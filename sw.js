const CACHE='daktent-v3';const FILES=['./','index.html','styles.css','login.css','app.js','api.js','auth.js','storage.js','seed.js','config.js','manifest.webmanifest','assets/icon.svg'];
