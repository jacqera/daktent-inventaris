const CACHE='daktent-v13';const FILES=['./','index.html','styles.css','loading.css','login.css','background.css','background.jpg','app.js','api.js','auth.js','storage.js','seed.js','config.js','manifest.webmanifest','assets/icon.svg'];
